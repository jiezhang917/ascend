    ...
    <div class="relative flex items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:pt-0">
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="text-center mt-6 text-dark-slate-blue">
                <h1 class="text-xl">Welcome to HELB</h1>
                <p class="text-sm mt-2">We are here to help small business owners like you.</p>
            </div>

            <div class="flex justify-center mt-24">
                <div class="w-80">
                    <vue-button class="btn-start uppercase text-white text-sm font-bold w-full justify-center py-3 rounded-xl mb-7">
                        Get Started
                    </vue-button>
...
<script>
    import VueButton from '@/Jetstream/Button'
